...
export default function AppointmentList({ appointments = [], loading, onDelete, onStatusChange }) {
  ...
  const handleDeleteConfirm  = () => { onDelete(confirmDelete); setConfirmDelete(null); };
